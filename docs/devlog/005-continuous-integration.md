...
pinned PlatformIO version, runs native unit tests, builds the firmware, and
uploads the generated binary files as workflow artifacts.
...
- run fast tests for pure logic such as active-note tracking;
